...
$player_id = isset($_GET['player_id']) ? intval($_GET['player_id']) :160;
...
echo "<p><strong>Hücum Yeteneği:</strong> Endrick, çok genç yaşına rağmen olağanüstü bir hücum yeteneğine sahip. Dribbling, bitiricilik ve pozisyon alma konularında etkileyici. Hızlı ve çevik yapısı, rakip savunmalarını zor durumda bırakıyor. Topla olan kontrolü ve teknik becerileri, onu yetenekli bir golcü yapıyor. Duran toplarda da etkinlik gösterebilir.</p>";

echo "<p><strong>İlk Dokunuş ve Baskı Altında Oyun:</strong> Endrick, baskı altında bile soğukkanlı kalmayı başarır ve topu verimli şekilde kullanır. İlk dokunuşu güçlü ve bu da ona oyun içerisinde hız kazandırır. Topu rahatça kontrol ederek, takımının hücumuna etkili bir şekilde katılır.</p>";

echo "<p><strong>Fiziksel Güç ve Çalışkanlık:</strong> Endrick, fiziksel olarak güçlü olmasa da çevikliği ve hızı sayesinde savunmalara karşı büyük bir tehdit oluşturur. Hızlı koşuları ve dribbling becerisiyle rakiplerinden kolayca sıyrılabilir. Genç yaşına rağmen büyük bir çalışma azmi ve motivasyona sahiptir.</p>";

echo "<p><strong>Pozisyonlar:</strong> Endrick, genellikle forvet ve kanat oyuncusu olarak görev yapar. Hem merkeze yakın hem de kenarlarda etkili bir şekilde oynayabilen çok yönlü bir oyuncudur. Savunmanın arkasına sızma yeteneği ile tehlike yaratır.</p>";

echo "<p><strong>Zayıf Yönler:</strong></p>";
echo "<ul>
    <li><strong>Fiziksel Dayanıklılık:</strong> Fiziksel olarak güçlü olsa da, daha üst seviyelerde mücadele etmek için dayanıklılığını geliştirmesi gerekebilir.</li>
    <li><strong>Savunmaya Katkı:</strong> Endrick, hücum odaklı bir oyuncu olduğu için savunma görevlerinde sınırlı katkı sağlıyor.</li>
</ul>";

echo "<p><strong>Savunma Katkısı:</strong> Endrick, hücum odaklı bir oyuncu olduğu için savunma görevlerinde pek yer almaz. Ancak topu kaybettiğinde geri koşarak takımına savunma açısından fayda sağlayabilir.</p>";

echo "<p><strong>Fiziksel ve Mental Özellikler:</strong></p>";
echo "<ul>
    <li><strong>Çeviklik:</strong> Endrick'in çevikliği ve hızı, savunmalar karşısında ona büyük bir avantaj sağlar.</li>
    <li><strong>Flair:</strong> Yaratıcı ve beklenmedik hareketleri ile rakip defanslara zor anlar yaşatabilir.</li>
    <li><strong>Çalışkanlık:</strong> Sahada sürekli bir mücadeleci ruh sergileyerek takımına katkı sağlar.</li>
</ul>";

echo "<p><strong>Kariyer Gelişimi ve Potansiyeli:</strong> Endrick, genç yaşında büyük bir potansiyele sahip. Yetenekleri, çevikliği ve gole dönük oyun tarzı, onu dünya çapında bir oyuncu olma yolunda ilerletiyor. Gelişen oyunuyla gelecekte çok daha üst seviyelere çıkması bekleniyor.</p>";
...
$main_player_id = 160; // Örneğin, ana oyuncunun ID'si 1 olarak ayarlandı. Dinamik hale getirilebilir.
