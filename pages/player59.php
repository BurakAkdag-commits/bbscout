...
$player_id = isset($_GET['player_id']) ? intval($_GET['player_id']) :59;
...
echo "<p><strong>Hücum Yeteneği:</strong> Cher Ndour, ofansif anlamda sahada fark yaratan bir orta saha oyuncusudur. Özellikle pas araları yaparak oyunu hızlandırma ve ileriye dönük top taşımada etkili rol oynar. Şutları ve hücum aksiyonlarına katılımıyla hücum varyasyonlarına değer katar.</p>";

echo "<p><strong>İlk Dokunuş ve Baskı Altında Oyun:</strong> Ndour, dar alanlarda top kontrolü ve baskı altındaki oyunuyla dikkat çeker. Yüksek teknik becerisi sayesinde zor durumlarda bile topu takım arkadaşlarına başarılı bir şekilde aktarabilir. Bu özellik, oyunu hızlandıran ve akıcı hale getiren bir etkendir.</p>";

echo "<p><strong>Fiziksel Güç ve Çalışkanlık:</strong> Cher Ndour, fiziksel olarak güçlü ve dayanıklı bir oyuncudur. Uzun boyu ve güçlü fiziği sayesinde hava toplarında etkili olmasının yanı sıra, yüksek dayanıklılığıyla maç boyunca istikrarlı bir performans sergiler. Hem defansif hem de ofansif anlamda sürekli katkı sağlayan bir oyun tarzına sahiptir.</p>";

echo "<p><strong>Pozisyonlar:</strong> Cher Ndour, orta saha merkezinde etkili bir oyun sergiler. Hem defansif orta saha hem de box-to-box orta saha rolünde görev yapabilir. Bu çok yönlülüğü, takımına taktiksel esneklik sağlar ve farklı dizilişlerde verimli bir şekilde oynamasına olanak tanır.</p>";

echo "<p><strong>Zayıf Yönler:</strong></p>";
echo "<ul>
    <li><strong>Şut Kararları:</strong> Bazı durumlarda şut tercihlerinde aceleci davranabiliyor, bu da isabetsiz denemelere yol açabiliyor.</li>
    <li><strong>Top Kapma:</strong> Fiziksel olarak güçlü olmasına rağmen, zaman zaman savunmada rakip oyunculardan topu kazanma konusunda eksiklikler gösterebiliyor.</li>
</ul>";

echo "<p><strong>Savunma Katkısı:</strong> Ndour, savunmada pozisyon alma ve rakip ataklarını kesme konusunda etkili bir oyuncudur. Oyun okuma becerisi ve takım savunmasına katkıları, onu orta sahada dengeli bir oyuncu yapar. Özellikle top kazanma ve hızlı hücuma geçişlerde kilit bir rol oynar.</p>";

echo "<p><strong>Fiziksel ve Mental Özellikler:</strong></p>";
echo "<ul>
    <li><strong>Liderlik:</strong> Genç yaşına rağmen sahada liderlik özellikleri gösterir ve takım arkadaşlarına güven verir.</li>
    <li><strong>Çalışkanlık:</strong> Sahada bitmek bilmeyen enerjisi ve yüksek çalışma disipliniyle her an etkili olabilecek bir oyuncudur.</li>
    <li><strong>Vizyon:</strong> Oyun görüşü sayesinde takımını hücuma hızlı bir şekilde taşıyabilir ve kritik anlarda doğru kararlar alabilir.</li>
</ul>";

echo "<p><strong>Kariyer Gelişimi ve Potansiyeli:</strong> Cher Ndour, genç yaşında Avrupa futbolunda dikkat çeken bir yetenektir. Sahadaki çok yönlü oyunu, fiziksel kapasitesi ve teknik becerileri, onu modern futbolun ihtiyaç duyduğu bir orta saha oyuncusu yapmaktadır. Disiplinli çalışması ve gelişime açık yapısıyla kariyerinde büyük başarılara ulaşması beklenmektedir.</p>";
...
$main_player_id =59; // Örneğin, ana oyuncunun ID'si 1 olarak ayarlandı. Dinamik hale getirilebilir.
