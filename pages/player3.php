...
<body>
    <div class="container">
        ...
        <div class="player-report">
            ...
            <p>
            <?php
echo "<p><strong>Hücum Yeteneği:</strong> Facundo Kruspzky, ofansif anlamda büyük bir potansiyele sahip bir oyuncudur. Hızlı, çevik ve etkili bir dripling yeteneği ile savunma oyuncularını geçmekte oldukça başarılıdır. Geçtiğimiz sezon, 30 maçta 6 gol ve 5 asistle, hücumda önemli katkılar sağlamıştır. Özellikle kanatlarda ve ceza sahasında etkili olabiliyor.</p>";

echo "<p><strong>İlk Dokunuş ve Baskı Altında Oyun:</strong> Kruspzky, top kontrolünde oldukça başarılı ve dar alanlarda topu iyi saklama yeteneğine sahiptir. Baskı altındayken doğru kararlar verme konusunda da olgunluk göstermektedir. Zor durumlarda dahi soğukkanlılığını koruyabiliyor.</p>";

echo "<p><strong>Fiziksel Güç ve Çalışkanlık:</strong> Hızlı ve çevik bir oyuncu olan Kruspzky, enerjik ve dayanıklı bir yapıya sahip. Hem hücumda hem de savunmada çalışkanlık sergileyerek takımına her iki yönde katkı sağlar. Sürekli hareket halinde olması, rakip savunmalar için zorlayıcı bir faktördür.</p>";

echo "<p><strong>Pozisyonlar:</strong> Kruspzky, kanat oyuncusu olarak görev alıyor ve özellikle sağ kanatta çok etkili. Bununla birlikte, forvet arkasında da görev alabiliyor. Hızlı ve teknik özellikleri sayesinde geniş alanda da başarıyla oynayabiliyor.</p>";

echo "<p><strong>Zayıf Yönler:</strong></p>";
echo "<ul>
    <li><strong>Karar Verme:</strong> Bazen topu kaybetme ve gereksiz riskler alma konusunda dikkat eksikliği yaşayabiliyor. Bu, özellikle son bölgedeki kararlarında daha dikkatli olmasını gerektiriyor.</li>
    <li><strong>Savunma Katkısı:</strong> Ofansif anlamda güçlü olsa da, savunma görevlerinde zaman zaman eksik kalabiliyor. Savunmaya katkı sağlamak için daha fazla disiplin geliştirmesi gerekiyor.</li>
</ul>";

echo "<p><strong>Savunma Katkısı:</strong> Genellikle ofansif bir oyuncu olsa da, bazen savunma katkılarına da yardımcı olabiliyor. Hızlı pres yapma ve rakip kanat oyuncularını sıkıştırma yeteneği var. Ancak, savunma görevlerinde daha tutarlı olması gerektiği söylenebilir.</p>";

echo "<p><strong>Fiziksel ve Mental Özellikler:</strong></p>";
echo "<ul>
    <li><strong>İnisiyatif:</strong> Kruspzky, maçı değiştirme potansiyeline sahip bir oyuncu. Sahada inisiyatif alabilen ve takımını yönlendirebilen özelliklere sahip.</li>
    <li><strong>Azim ve Çalışkanlık:</strong> Hem fiziksel hem de mental olarak oldukça çalışkan. Oyun boyunca gösterdiği azim ve hırs, onun gelişimine katkı sağlıyor.</li>
</ul>";

echo "<p><strong>Kariyer Gelişimi ve Potansiyeli:</strong> Facundo Kruspzky, genç yaşına rağmen büyük bir potansiyele sahip ve hızla gelişiyor. Modern futbolun ihtiyaç duyduğu teknik, hız ve çevikliğe sahip. Gelecek yıllarda, Avrupa'nın büyük liglerinde etkili bir oyuncu olma potansiyeli taşıyor.</p>";
?>
...
$main_player_id = 3; // Örneğin, ana oyuncunun ID'si 1 olarak ayarlandı. Dinamik hale getirilebilir.
