...
$player_id = isset($_GET['player_id']) ? intval($_GET['player_id']) :65;
...
echo "<p><strong>Hücum Yeteneği:</strong> Semih Kılıçsoy, hücumda özellikle hızlı ve etkili bir oyuncudur. Topu taşıma ve hızlı geçiş oyunlarıyla takımını ileriye taşır. Şut yeteneği kuvvetlidir, ancak zaman zaman isabetliliği konusunda geliştirilmesi gereken yönler vardır. Yine de, topu kaleye doğru yönlendirmede ve bitiricilikte iyi bir potansiyele sahiptir.</p>";

echo "<p><strong>İlk Dokunuş ve Baskı Altında Oyun:</strong> Semih, dar alanlarda top kontrolünde güçlüdür ve baskı altında soğukkanlı kalmayı başarır. Yüksek futbol zekası ve hızlı karar verme yeteneği, zor durumlarda bile doğru seçimler yapmasını sağlar. Bu özellikleri, onu baskı altındayken bile verimli bir oyuncu kılar.</p>";

echo "<p><strong>Fiziksel Güç ve Çalışkanlık:</strong> Semih Kılıçsoy, hız, çeviklik ve dayanıklılık konusunda çok iyi bir seviyededir. Hem hücum hem de savunma yönünde sürekli hareket halinde olup, her iki yönlü oyunuyla dikkat çeker. Uzun mesafelerdeki koşuları, ona rakiplerinden bir adım önde olma avantajı sağlar.</p>";

echo "<p><strong>Pozisyonlar:</strong> Semih Kılıçsoy'un en verimli olduğu pozisyonlar şunlardır:</p>";
echo "<ul>
    <li><strong>Sağ Kanat:</strong> Hızlı ve etkili bir sağ kanat oyuncusu olarak, rakip savunmaları zorlayabilir ve gol pozisyonlarına girebilir.</li>
    <li><strong>Merkez Orta Saha:</strong> Orta sahada oyun kurma ve pas dağıtma görevlerini üstlenebilir. Takımını ileri taşırken savunma katkısı da sağlar.</li>
</ul>";

echo "<p><strong>Zayıf Yönler:</strong></p>";
echo "<ul>
    <li><strong>Defansif Katkı:</strong> Savunma yönü konusunda gelişime açık. Özellikle rakip kanat oyuncularına karşı daha dikkatli olması gerekebilir.</li>
    <li><strong>Uzun Paslar:</strong> Uzun paslarda zaman zaman isabetsizlik yaşayabiliyor. Bu konuda çalışarak daha etkili hale gelebilir.</li>
</ul>";

echo "<p><strong>Savunma Katkısı:</strong> Semih, defansif yönde de takımına yardımcı olur. Hızlı pres yapma yeteneği ve rakip top taşıyan oyuncuları sıkıştırma konusundaki başarısı, onu savunma katkısı sağlayan değerli bir oyuncu yapar. Zaman zaman pozisyon alma ve oyun okuma becerileriyle de rakip ataklarını engeller.</p>";

echo "<p><strong>Fiziksel ve Mental Özellikler:</strong></p>";
echo "<ul>
    <li><strong>Liderlik:</strong> Genç yaşına rağmen takım arkadaşlarını motive etme ve yönlendirme yeteneği ile dikkat çeker. Saha içinde liderlik özelliği gösterebilir.</li>
    <li><strong>Çalışkanlık:</strong> Semih, maç boyunca enerjisini yüksek tutar ve sürekli olarak savunma ve hücum katkısı sağlamak için çalışır.</li>
</ul>";

echo "<p><strong>Kariyer Gelişimi ve Potansiyeli:</strong> Semih Kılıçsoy, genç yaşına rağmen büyük bir potansiyel sergileyen bir oyuncudur. Hem kulüp hem de milli takım seviyesinde kendini kanıtlama yolunda ilerlemektedir. Fiziksel ve teknik gelişimini sürdürdüğü takdirde, gelecekte Avrupa'nın üst düzey liglerinde önemli bir oyuncu olma potansiyeline sahiptir.</p>";
...
$main_player_id = 65; // Örneğin, ana oyuncunun ID'si 1 olarak ayarlandı. Dinamik hale getirilebilir.
