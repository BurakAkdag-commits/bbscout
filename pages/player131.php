...
$player_id = isset($_GET['player_id']) ? intval($_GET['player_id']) :131;
...
echo "<p><strong>Hücum Yeteneği:</strong> Cole Palmer, genç yaşına rağmen olağanüstü hücum yeteneklerine sahip bir oyuncudur. Dribbling becerisi, rakiplerini geçme konusundaki yeteneği ve top sürme becerileriyle dikkat çeker. Ayrıca, gol atma potansiyeli yüksek olup, özellikle kaleye uzak mesafeden şut çekme yeteneği gelişmiştir.</p>";

echo "<p><strong>İlk Dokunuş ve Baskı Altında Oyun:</strong> Palmer, top kontrolünde oldukça başarılıdır. İlk dokunuşu, oyununu hızlandıran ve takımına hareketli bir geçiş fırsatı sağlayan önemli bir özelliktir. Baskı altındayken soğukkanlılıkla topu kontrol edebilir ve doğru kararlar verebilir.</p>";

echo "<p><strong>Fiziksel Güç ve Çalışkanlık:</strong> Palmer, çevikliği ve hızlı ayaklarıyla dikkat çeker. Hızı, rakip savunmalarını zor durumda bırakabilir. Fiziksel olarak daha güçlü hale gelmesi, onu daha etkili bir oyuncu yapabilir. Çalışkanlık açısından ise her zaman mücadeleci bir tavır sergiler.</p>";

echo "<p><strong>Pozisyonlar:</strong> Genellikle kanat oyuncusu olarak görev alır ve burada çok yönlülüğüyle dikkat çeker. Hem sol kanatta hem de sağ kanatta etkili bir şekilde oynayabilir. Ayrıca, gerektiğinde forvet arkasında da görev alabilecek teknik ve oyun zekasına sahiptir.</p>";

echo "<p><strong>Zayıf Yönler:</strong></p>";
echo "<ul>
    <li><strong>Fiziksel Direnç:</strong> Yaşı gereği bazı fiziksel mücadelelerde zorlanabilir. Daha fazla güç ve direnç geliştirmesi faydalı olacaktır.</li>
    <li><strong>Savunma Katkısı:</strong> Hücum odaklı bir oyuncu olarak, savunma görevlerine katkı sağlamada zaman zaman eksiklikler görülebilir.</li>
</ul>";

echo "<p><strong>Savunma Katkısı:</strong> Savunmaya doğrudan katkısı sınırlı olmakla birlikte, gerektiğinde rakip oyuncuları pres yaparak top kazanma konusunda etkili olabilir. Daha fazla savunma farkındalığı geliştirmesi, onu daha komple bir oyuncu yapabilir.</p>";

echo "<p><strong>Fiziksel ve Mental Özellikler:</strong></p>";
echo "<ul>
    <li><strong>Hız:</strong> Hızı, rakip savunmaları zor durumda bırakmak için önemli bir avantajdır.</li>
    <li><strong>Çalışkanlık:</strong> Palmer, her zaman sahada yüksek bir çalışkanlık sergileyerek mücadele eder.</li>
    <li><strong>Flair:</strong> Yaratıcı oyun tarzı ve beklenmedik hareketleriyle rakip savunmalar için zorlayıcı bir oyuncudur.</li>
</ul>";

echo "<p><strong>Kariyer Gelişimi ve Potansiyeli:</strong> Cole Palmer, genç yaşına rağmen büyük bir potansiyele sahip bir oyuncudur. Oyun zekası, teknik becerileri ve hızını geliştirmesiyle kısa süre içinde daha büyük liglerde kendine yer bulabilir. Kariyerinde daha fazla deneyim kazandıkça, Avrupa'nın en yetenekli kanat oyuncularından biri olabilir.</p>";
...
$main_player_id = 131; // Örneğin, ana oyuncunun ID'si 1 olarak ayarlandı. Dinamik hale getirilebilir.
