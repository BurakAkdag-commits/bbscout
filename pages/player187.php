...
$player_id = isset($_GET['player_id']) ? intval($_GET['player_id']) :187;
...
echo "<p><strong>Hücum Yeteneği:</strong> Leny Yoro, top sürme, dribbling ve tekniği ile dikkat çeker. Dribblingdeki yüksek yeteneği ve top kontrolündeki soğukkanlılık, onu hücumda etkili kılar. Finishing ve uzun şutlar da önemli özellikleri arasında yer alır, ancak bitiriciliği daha da geliştirilebilir. Duran toplarda da iyi bir performans sergileyebilir.</p>";

echo "<p><strong>İlk Dokunuş ve Baskı Altında Oyun:</strong> Yoro'nun ilk dokunuşu genellikle güçlü ve doğru olur. Baskı altındayken de sakin kalabilen bir oyuncudur. Hızlı oyun kurma ve top kontrolündeki becerisiyle takımını ileriye taşır. Topla oynamadığında ise takımının oyununa etki edebilecek doğru kararlar alabilir.</p>";

echo "<p><strong>Fiziksel Güç ve Çalışkanlık:</strong> Leny Yoro, hızlı ve çevik bir oyuncu olup bu yeteneklerini hücumda avantaj olarak kullanır. Fiziksel olarak daha güçlü olmasına rağmen, zayıf yönleri arasında zaman zaman güç eksiklikleri yaşadığı görülür. Ancak, hız ve çevikliğini sürekli olarak kullanarak maç boyunca etkili olur.</p>";

echo "<p><strong>Pozisyonlar:</strong> Yoro genellikle ofansif orta saha ve kanat oyuncusu olarak görev yapar, ancak gerektiğinde başka pozisyonlarda da oynayabilir. Takımının hücum organizasyonlarında çok yönlülüğü önemli bir avantajdır. Rakip savunmaları zor durumda bırakma ve geniş alanları kullanma yeteneği ile dikkat çeker.</p>";

echo "<p><strong>Zayıf Yönler:</strong></p>";
echo "<ul>
    <li><strong>Fiziksel Güç:</strong> Güçlü olmasına rağmen, bazı mücadelelerde fiziksel zorluklar yaşayabilir. Özellikle hava toplarında daha güçlü rakiplere karşı zayıf kalabiliyor.</li>
    <li><strong>Savunma Katkısı:</strong> Hücum odaklı bir oyuncu olduğundan savunmaya katkısı sınırlıdır. Top kapma ve savunma görevlerini geliştirmesi gereken alanlar arasında yer alıyor.</li>
</ul>";

echo "<p><strong>Savunma Katkısı:</strong> Hücumda etkili olmasına rağmen, savunmaya katkı sağlamakta sınırlıdır. Ancak gerektiğinde rakip hücumları engellemeye çalışarak takımına yardımcı olabilir. Hızlı koşuları ve doğru yerleşimi ile bazen önemli müdahalelerde bulunabilir.</p>";

echo "<p><strong>Fiziksel ve Mental Özellikler:</strong></p>";
echo "<ul>
    <li><strong>Hız ve Çeviklik:</strong> Yoro'nun hız ve çevikliği, rakip savunmaları geçmesinde önemli bir avantaj sağlar. Bu özellikleri sayesinde önemli hücum tehditleri oluşturur.</li>
    <li><strong>Flair:</strong> Yaratıcı ve beklenmedik hareketleri, rakip savunmaların dengesini bozarak ona fırsatlar yaratır. Yoro'nun flair'ı, onun en belirgin özelliklerinden biridir.</li>
    <li><strong>Çalışkanlık:</strong> Sürekli olarak çalışma hızı sergileyen ve takımına katkı sağlayan bir oyuncudur. Her zaman takımına değer katar.</li>
</ul>";

echo "<p><strong>Kariyer Gelişimi ve Potansiyeli:</strong> Leny Yoro, genç yaşına rağmen büyük bir potansiyele sahip bir oyuncudur. Teknik becerileri, hızla gelişen oyun tarzı ve çalışkanlığı ile gelecekte çok daha yüksek seviyelere ulaşması bekleniyor. Doğru yönlendirme ve deneyimle, Avrupa'nın en önemli oyuncularından biri olabilir.</p>";
...
$main_player_id = 187; // Örneğin, ana oyuncunun ID'si 1 olarak ayarlandı. Dinamik hale getirilebilir.
