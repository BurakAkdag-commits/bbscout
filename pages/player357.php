...
$player_id = isset($_GET['player_id']) ? intval($_GET['player_id']) :357;
...
<body>
   ...
   echo "<p><strong>Hücum Yeteneği:</strong> Florian Wirtz, hücum anlamında çok yönlü ve etkili bir oyuncudur. Teknik becerileri ve 
   pas yeteneği sayesinde takımının hücumlarını yönlendirme konusunda öne çıkar. Yaratıcı oyun zekası ve yüksek vizyonuyla, zor 
   pozisyonlarda bile etkili çözümler üretebilir. Ayrıca bire bir mücadelelerde oldukça başarılıdır ve takım arkadaşları için 
   boş alan yaratmada üst düzey performans gösterir.</p>";

   echo "<p><strong>İlk Dokunuş ve Baskı Altında Oyun:</strong> Florian, mükemmel bir ilk dokunuşa ve baskı altındaki oyun 
   becerisine sahiptir. Dar alanlarda hızlı karar verme yeteneğiyle rakip savunmayı zor durumda bırakır. Özellikle topa sahipken 
   soğukkanlılığı ve pas tercihlerindeki isabet oranıyla fark yaratır.</p>";

   echo "<p><strong>Fiziksel Güç ve Çalışkanlık:</strong> Florian Wirtz, çevikliği ve dayanıklılığı ile dikkat çeker. Güçlü 
   bir fizik yapısına sahip olmasa da esnekliği ve hızlanma kabiliyetiyle bunu telafi eder. İkili mücadelelerde kararlılığı 
   sayesinde savunma ve hücumda takımı adına önemli katkılar sağlar.</p>";

   echo "<p><strong>Pozisyonlar:</strong> Florian Wirtz, modern futbolun ofansif orta saha rolüne uygun bir oyuncudur. 
   10 numara pozisyonunda oynayabildiği gibi, kanatlarda da etkili performans gösterebilir. Çok yönlülüğü sayesinde farklı 
   taktik dizilimlere kolayca uyum sağlayabilir.</p>";

   echo "<p><strong>Savunma Katkısı:</strong> Florian, hücumda olduğu kadar savunmada da takımına fayda sağlayan bir oyuncudur. 
   Rakip top kayıplarını değerlendirme ve baskı kurma konusunda başarılıdır. Pozisyon bilgisi ve agresif oyun yapısı sayesinde, 
   rakip hücumlarını kesmede etkili bir performans sergiler.</p>";

   echo "<p><strong>Fiziksel ve Mental Özellikler:</strong></p>";
   echo "<ul>
       <li><strong>Vizyon:</strong> Florian, sahada oyunu okuma ve doğru kararlar verme konusunda olağanüstü bir vizyona sahiptir.</li>
       <li><strong>Flair:</strong> Yaratıcılığı ve teknik becerileri sayesinde beklenmedik anlarda oyunu değiştirme yeteneğine sahiptir.</li>
       <li><strong>Çalışkanlık:</strong> Takımına sürekli katkı sağlayan, enerjik ve oyundan kopmayan bir yapıya sahiptir.</li>
   </ul>";

   echo "<p><strong>Kariyer Gelişimi ve Potansiyeli:</strong> Florian Wirtz, genç yaşına rağmen futbol dünyasında adından sıkça 
   söz ettirmektedir. Teknik becerileri ve gelişime açık yapısıyla, gelecekte Avrupa'nın en iyi ofansif orta sahalarından biri 
   olma potansiyeline sahiptir. Çalışma disiplini ve futbol zekasıyla üst düzey kulüplerin radarındadır.</p>";
...
$main_player_id = 357; // Örneğin, ana oyuncunun ID'si 1 olarak ayarlandı. Dinamik hale getirilebilir.
