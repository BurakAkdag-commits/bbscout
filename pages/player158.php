...
$player_id = isset($_GET['player_id']) ? intval($_GET['player_id']) :158;
...
echo "<p><strong>Hücum Yeteneği:</strong> Arda Güler, hücumda etkili bir oyuncu olarak dikkat çeker. Dribbling yeteneği ve bitiriciliği onu savunmalar için tehlikeli bir tehdit haline getirir. Ayrıca, oyunun temposunu hızlandıran pasları ve ilk dokunuşu ile hücuma yön verebilir. Duran toplarda etkili olabilir, ancak kafa toplarında daha fazla gelişim gösterebilir.</p>";

echo "<p><strong>İlk Dokunuş ve Baskı Altında Oyun:</strong> Arda, top kontrolü konusunda oldukça soğukkanlı ve baskı altında dahi doğru kararlar alır. Bu özellikleri, oyun kurma ve hızlı ataklar yaratma konusunda ona büyük avantaj sağlar. İlk dokunuşu mükemmel olup, oyun akışını hızlandırmaya yardımcı olur.</p>";

echo "<p><strong>Fiziksel Güç ve Çalışkanlık:</strong> Arda Güler, çevikliği, hızı ve dengeyi hücumda avantaj olarak kullanır. Fiziksel olarak güçlü olsa da, bazı durumlarda rakiplerine karşı zorluklar yaşayabilir. Maç boyunca verimli bir tempoda çalışarak, takımının hücum gücüne katkı sağlar.</p>";

echo "<p><strong>Pozisyonlar:</strong> Genellikle ofansif orta saha ve kanat oyuncusu olarak görev alır. Ancak gerektiğinde farklı pozisyonlarda da oynayabilir. Hücumda çok yönlüdür ve rakip savunmalarına karşı etkili olabilir.</p>";

echo "<p><strong>Zayıf Yönler:</strong></p>";
echo "<ul>
    <li><strong>Fiziksel Güç:</strong> Güçlü bir oyuncu olmakla birlikte, bazen fiziksel mücadelelerde zorluk yaşayabilir.</li>
    <li><strong>Savunma Katkısı:</strong> Savunma görevlerinde zaman zaman eksiklikler yaşar ve top kapma konusunda geliştirilmesi gereken yönler vardır.</li>
</ul>";

echo "<p><strong>Savunma Katkısı:</strong> Hücum odaklı bir oyuncu olan Arda Güler, savunmada fazla katkı vermez. Ancak gerektiğinde rakip hücumlardan top kazanabilir.</p>";

echo "<p><strong>Fiziksel ve Mental Özellikler:</strong></p>";
echo "<ul>
    <li><strong>Hız:</strong> Yüksek hız ve çevikliği sayesinde rakip savunmaları kolaylıkla geçebilir.</li>
    <li><strong>Flair:</strong> Yaratıcı oyun tarzı ve beklenmedik hareketleri ile rakip defanslara zor anlar yaşatabilir.</li>
    <li><strong>Çalışkanlık:</strong> Maç boyunca sürekli bir çalışma temposu sergileyerek, takımına katkı sağlar.</li>
</ul>";

echo "<p><strong>Kariyer Gelişimi ve Potansiyeli:</strong> Arda Güler, büyük bir potansiyele sahip genç bir oyuncudur. Teknik yetenekleri ve hızla gelişen oyun tarzı ile gelecekte çok daha yüksek seviyelere ulaşması beklenmektedir.</p>";
...
$main_player_id = 158; // Örneğin, ana oyuncunun ID'si 1 olarak ayarlandı. Dinamik hale getirilebilir.
