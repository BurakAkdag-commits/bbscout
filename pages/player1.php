...
$player_id = isset($_GET['player_id']) ? intval($_GET['player_id']) : 1;
...
<body>
    <div class="container">
        ...
        <div class="player-report">
            ...
            <p>
            <?php
            echo "<p><strong>Hücum Yeteneği:</strong> Geçtiğimiz sezon Real Madrid formasıyla 42 maçta 27 gol ve 17 asist üreterek olağanüstü bir hücum katkısı sağladı. 
            Özellikle geç koşularla ceza sahasında tehlike yaratıyor ve her iki ayağıyla da etkili bitiricilik sergiliyor.</p>";

            echo "<p><strong>İlk Dokunuş ve Baskı Altında Oyun:</strong> Bellingham, dar alanlarda topu kontrol etme ve pres altındayken doğru kararlar verme konusunda çok başarılı.</p>";

            echo "<p><strong>Fiziksel Güç ve Çalışkanlık:</strong> Yüksek enerjisi, dayanıklılığı ve ikili mücadelelerdeki başarısıyla dikkat çekiyor. Hem hücum hem de savunma yönünde çalışkan bir oyuncu.</p>";

            echo "<p><strong>Pozisyonlar:</strong> 4-3-3’te <em>box-to-box orta saha</em>, 4-2-3-1’de <em>10 numara</em>, ve <em>defansif orta saha (6 numara)</em> olarak oynayabiliyor. 
            Bu çok yönlülüğü, Bellingham’ı farklı taktik sistemlere uyum sağlayabilen bir oyuncu yapıyor.</p>";

            echo "<p><strong>Zayıf Yönler:</strong></p>";
            echo "<ul>
                <li><strong>Yaratıcılık:</strong> Hücumda bireysel yaratıcılığı sınırlı. Genellikle kolektif oyunla etkili oluyor.</li>
                <li><strong>Uzun Paslar:</strong> Uzun pas konusunda gelişime açık. Daha fazla doğruluk ve çeşitlilik eklemesi gerekiyor.</li>
            </ul>";

            echo "<p><strong>Savunma Katkısı:</strong> Yüksek pres yeteneği ve ikili mücadelelerdeki başarısıyla takım savunmasına önemli katkılar yapıyor. 
            Genç yaşına rağmen pozisyon alma ve oyun okuma becerileri oldukça gelişmiş.</p>";

            echo "<p><strong>Fiziksel ve Mental Özellikler:</strong></p>";
            echo "<ul>
                <li><strong>Liderlik:</strong> Takım arkadaşlarını yönlendirme ve saha içindeki sorumluluğu üstlenme becerisi, yaşından beklenmeyecek bir olgunluk sergiliyor.</li>
                <li><strong>Mücadeleci Ruh:</strong> Hem fiziksel hem de mental dayanıklılığı yüksek. Zor maçlarda baskı altında dahi performansını koruyabiliyor.</li>
            </ul>";

            echo "<p><strong>Kariyer Gelişimi ve Potansiyeli:</strong> Bellingham, hem kulüp hem de milli takım seviyesinde lider oyuncu rolüne adım atmış durumda. 
            Çok yönlülüğü, güçlü fiziği ve hücum-savunma dengesiyle Avrupa futbolunun en değerli oyuncularından biri olarak kabul ediliyor. 
            Gelişime açık yönleriyle birkaç yıl içinde daha da üst seviyelere çıkma potansiyeline sahip.</p>"
            ?>
             <?php
// Veritabanı bağlantısı
...
$main_player_id = 1; // Örneğin, ana oyuncunun ID'si 1 olarak ayarlandı. Dinamik hale getirilebilir.
