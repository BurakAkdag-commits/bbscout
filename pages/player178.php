...
$player_id = isset($_GET['player_id']) ? intval($_GET['player_id']) :178;
...
echo "<p><strong>Hücum Yeteneği:</strong> Andreas Schjelderup, hücumda oldukça yetenekli bir oyuncudur. Dribbling yeteneği ve bitiriciliğiyle savunmalar karşısında etkili olabilir. Özellikle kanat oyuncusu olarak, rakip savunmalarına karşı hızlı ve çevik hareketler sergileyebilir. Ayrıca, duran toplarda da etkin bir şekilde rol alabilir.</p>";

echo "<p><strong>İlk Dokunuş ve Baskı Altında Oyun:</strong> Schjelderup'un ilk dokunuşu oldukça güçlü ve oyun görüşü ile baskı altındayken bile top kontrolü sağlayabilir. Hızlı düşünme ve doğru kararlar alma yeteneği ile oyun akışını hızlandırır ve takımının hücum organizasyonlarını yönetir.</p>";

echo "<p><strong>Fiziksel Güç ve Çalışkanlık:</strong> Oyuncu, çevikliği ve hızıyla dikkat çeker. Fiziksel gücü, rakiplerin savunmasını aşarken ona avantaj sağlar. Çalışkanlığı ve saha içinde sürekli olarak gösterdiği tempo, onu takımına önemli katkılar sağlayan bir oyuncu yapar.</p>";

echo "<p><strong>Pozisyonlar:</strong> Genellikle kanat oyuncusu olarak görev yapar, ancak gerektiğinde forvet veya ofansif orta saha olarak da oynayabilir. Esnek yapısı, farklı pozisyonlarda etkili olmasını sağlar ve hücumda çeşitli görevlerde yer alabilir.</p>";

echo "<p><strong>Zayıf Yönler:</strong></p>";
echo "<ul>
    <li><strong>Fiziksel Dayanıklılık:</strong> Hızlı ve çevik olmasına rağmen, fiziksel dayanıklılığı zaman zaman yetersiz kalabilir. Bu da özellikle uzun süreli koşularda etkisini gösterebilir.</li>
    <li><strong>Savunma Katkısı:</strong> Savunmaya katkısı sınırlıdır ve top kapma becerilerini geliştirmesi gerekebilir.</li>
</ul>";

echo "<p><strong>Savunma Katkısı:</strong> Schjelderup, hücum odaklı bir oyuncudur. Savunmada fazla katkı vermez, ancak gerektiğinde rakiplerin oyun kurmasına engel olma adına hızlı bir şekilde geri çekilebilir.</p>";

echo "<p><strong>Fiziksel ve Mental Özellikler:</strong></p>";
echo "<ul>
    <li><strong>Hız:</strong> Schjelderup'un hızı, ona savunmalara karşı büyük avantaj sağlar. Özellikle kontra ataklarda çok etkili olabilir.</li>
    <li><strong>Flair:</strong> Oyuncu, yaratıcı ve beklenmedik hareketleriyle rakip defansları zor durumda bırakabilir.</li>
    <li><strong>Çalışkanlık:</strong> Sürekli hareket halinde olan ve takımı için her zaman çaba sarf eden bir oyuncudur.</li>
</ul>";

echo "<p><strong>Kariyer Gelişimi ve Potansiyeli:</strong> Andreas Schjelderup, genç yaşta büyük bir potansiyele sahip. Hızla gelişen oyun tarzı ve teknik özellikleri ile daha üst düzey bir oyuncu olma yolunda ilerlemektedir. Kariyerinde doğru yönlendirme ve deneyimle, büyük kulüplerde önemli bir oyuncu olması bekleniyor.</p>";
...
$main_player_id = 178; // Örneğin, ana oyuncunun ID'si 1 olarak ayarlandı. Dinamik hale getirilebilir.
