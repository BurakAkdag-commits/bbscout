...
$player_id = isset($_GET['player_id']) ? intval($_GET['player_id']) :112;
...
<body>
    <div class="container">
        ...
        <div class="player-report">
            ...
            <p>
            <?php
    echo "<p><strong>Hücum Yeteneği:</strong> Bukayo Saka, hücum hattında çok yönlü bir oyuncu olarak öne çıkar. Hızı, çevikliği ve top kontrolüyle rakip savunmaları zor durumda bırakır. Özellikle bire bir pozisyonlarda etkili olup, hem içeri kat eden koşularla hem de kenarda top sürerek tehlikeli fırsatlar yaratır. Pas yeteneği ve karar alma becerisiyle takım arkadaşlarına gol şansı sunar.</p>";

    echo "<p><strong>İlk Dokunuş ve Baskı Altında Oyun:</strong> Saka, baskı altında serinkanlılığını koruyarak etkili oyun sergiler. İlk dokunuşları ve topu kontrol etme yeteneği sayesinde dar alanlarda bile oyunu yönlendirebilir. Yaratıcı oyun görüşü, rakip savunmaları delip geçen paslar yapmasına olanak tanır.</p>";

    echo "<p><strong>Fiziksel Güç ve Çalışkanlık:</strong> Bukayo Saka, dayanıklılığı ve çevikliğiyle fiziksel mücadelelerde etkili bir oyuncudur. Hızlanma ve temposuyla savunma arkasına koşular yaparak fark yaratır. Ayrıca çalışma azmi ve enerjisiyle her iki yönlü oyuna katkı sağlar, takım arkadaşları için alan açar.</p>";

    echo "<p><strong>Pozisyonlar:</strong> Saka, çok yönlü bir oyuncu olarak farklı pozisyonlarda oynayabilir. Genellikle sağ kanat oyuncusu olarak görev yapsa da, sol kanatta ve hatta gerektiğinde bek pozisyonunda da etkili performans sergileyebilir. Bu esnekliği, hem ofansif hem de defansif sistemlerde kilit bir oyuncu olmasını sağlar.</p>";

    echo "<p><strong>Savunma Katkısı:</strong> Saka, yalnızca hücumda değil, savunmada da takımına değer katan bir oyuncudur. Rakiplerin top kayıplarını fırsata çevirir ve savunma hattına destek sağlayarak takımın dengeli bir şekilde oynamasına yardımcı olur. Çalışkanlığı ve oyun disiplini, savunma katkısında da önemli rol oynar.</p>";

    echo "<p><strong>Fiziksel ve Mental Özellikler:</strong></p>";
    echo "<ul>
        <li><strong>Vizyon:</strong> Saka, oyun görüşü ve saha içindeki zekasıyla fark yaratır. Takım arkadaşlarına yaratıcı paslar sunar ve tehlikeli pozisyonların oluşmasını sağlar.</li>
        <li><strong>Flair:</strong> Teknik becerileri ve cesur oyun tarzıyla rakipleri zor durumda bırakabilir. Topla etkili ve beklenmedik hareketlerle hücum fırsatları yaratır.</li>
        <li><strong>Çalışkanlık:</strong> Enerjik yapısı ve oyuna olan bağlılığı, onu her iki yönlü bir tehdit haline getirir. Savunmaya katkıda bulunurken aynı zamanda hücumda da etkisini hissettirir.</li>
    </ul>";

    echo "<p><strong>Kariyer Gelişimi ve Potansiyeli:</strong> Bukayo Saka, genç yaşına rağmen Avrupa futbolunun en dikkat çekici yeteneklerinden biri olarak görülmektedir. Çalışma disiplini, çok yönlülüğü ve liderlik özellikleriyle gelecekte dünya futbolunun en üst düzey oyuncuları arasında yer alması bekleniyor. Gelişim potansiyeli, Arsenal ve İngiltere Milli Takımı için büyük bir değer taşıyor.</p>";
...
$main_player_id = 112; // Örneğin, ana oyuncunun ID'si 1 olarak ayarlandı. Dinamik hale getirilebilir.
