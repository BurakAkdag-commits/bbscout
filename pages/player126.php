...
$player_id = isset($_GET['player_id']) ? intval($_GET['player_id']) :126;
...
echo "<p><strong>Hücum Yeteneği:</strong> Romeo Lavia, bir orta saha oyuncusu olarak hücum organizasyonlarında kilit roller üstlenir. Pas becerisi ve oyun görüşü, takımının hücuma geçiş oyunlarında etkili olmasını sağlar. Ceza sahası çevresinde yaptığı ara paslar ve şut denemeleriyle hücum hattına değer katar.</p>";

echo "<p><strong>İlk Dokunuş ve Baskı Altında Oyun:</strong> Lavia, dar alanlarda bile soğukkanlı kalmayı başarır ve topu kontrol eder. Baskı altındaki oyun tarzı, takımının orta sahada topa hakim olmasına katkıda bulunur. İlk dokunuşundaki hassasiyet, oyunun hızını artırır ve takım arkadaşlarına boş alanlar yaratır.</p>";

echo "<p><strong>Fiziksel Güç ve Çalışkanlık:</strong> Romeo Lavia, fiziksel dayanıklılığı ve çalışma azmiyle dikkat çeker. Hem savunma hem de hücumda sürekli hareket halinde olan bir oyuncudur. Fiziksel olarak güçlü olmasa da çevikliği ve hızlanma kabiliyeti sayesinde ikili mücadelelerde başarılı olur.</p>";

echo "<p><strong>Pozisyonlar:</strong> Lavia, doğal olarak defansif orta saha pozisyonunda oynar ve bu bölgede harika performanslar sergiler. Ayrıca, gerektiğinde merkez orta saha veya derin oyun kurucu rollerinde de etkili olabilir. Çok yönlülüğü, takımının taktiksel esnekliğini artırır.</p>";

echo "<p><strong>Zayıf Yönler:</strong></p>";
echo "<ul>
    <li><strong>Şut Kararları:</strong> Hücumda daha fazla etki yaratmak için şut tercihlerini geliştirmesi gerekiyor.</li>
    <li><strong>Hava Topları:</strong> Uzun boylu olmaması, hava toplarındaki etkisini sınırlıyor. Bu alanda kendini geliştirmesi faydalı olacaktır.</li>
</ul>";

echo "<p><strong>Savunma Katkısı:</strong> Lavia, savunma anlamında oyunun her anında yer alır. Rakip atakları kesme, pas arası yapma ve baskı uygulama konularında üst düzey bir performans sergiler. Oyunun savunma yönünde sürekli etkili olması, takımını dengede tutar.</p>";

echo "<p><strong>Fiziksel ve Mental Özellikler:</strong></p>";
echo "<ul>
    <li><strong>Oyun Görüşü:</strong> Pas seçeneklerini hızlı bir şekilde değerlendirme yeteneği, takım arkadaşlarına alan yaratmasını sağlar.</li>
    <li><strong>Çalışkanlık:</strong> Sahada sürekli mücadele eden ve takımının temposunu yukarı çeken bir oyuncudur.</li>
    <li><strong>Kararlılık:</strong> Zor anlarda sorumluluk alarak takımını yönlendirme becerisine sahiptir.</li>
</ul>";

echo "<p><strong>Kariyer Gelişimi ve Potansiyeli:</strong> Romeo Lavia, genç yaşına rağmen oyun zekası ve çok yönlülüğüyle büyük bir potansiyele sahiptir. Orta sahadaki disiplini, teknik kapasitesi ve sürekli gelişim arzusu sayesinde gelecekte Avrupa'nın en üst düzey orta saha oyuncularından biri olması bekleniyor.</p>";
...
$main_player_id = 126; // Örneğin, ana oyuncunun ID'si 1 olarak ayarlandı. Dinamik hale getirilebilir.
