                  ...
                  <g transform="translate(-1716.000000, -439.000000)" fill="#FFFFFF" fill-rule="nonzero">
                    <g transform="translate(1716.000000, 291.000000)">
                      <g transform="translate(0.000000, 148.000000)">
                        ...
                        <path class="color-background" d="M39.198,22.4912623 C37.3776246,22.4928106 35.5817531,22.0149171 33.951625,21.0951667 L33.92225,21.1107282 C31.1430221,22.6838032 27.9255001,22.93116 24.9844167,21.7998837 C24.4750389,21.605469 23.9777983,21.3722567 23.4960833,21.1018359 L23.4745417,21.1129513 C20.6961809,22.6871153 17.4786145,22.9344611 14.5386667,21.7998837 C14.029926,21.6054643 13.533337,21.3722507 13.0522917,21.1018359 C11.4250962,22.0190609 9.63246555,22.4947009 7.81570833,22.4912623 C7.16510551,22.4842162 6.51607673,22.4173045 5.875,22.2911849 L5.875,44.7220845 C5.875,45.9498589 6.7517757,46.9451667 7.83333333,46.9451667 L19.5833333,46.9451667 L19.5833333,33.6066734 L27.4166667,33.6066734 L27.4166667,46.9451667 L39.1666667,46.9451667 C40.2482243,46.9451667 41.125,45.9498589 41.125,44.7220845 L41.125,22.2822926 C40.4887822,22.4116582 39.8442868,22.4815492 39.198,22.4912623 Z"></path>
                      </g>
                    </g>
                  </g>
                </g>
...
$player_id = isset($_GET['player_id']) ? intval($_GET['player_id']) :127;
...
echo "<p><strong>Hücum Yeteneği:</strong> Enzo Fernández, hücum organizasyonlarında önemli bir rol oynayan bir orta saha oyuncusudur. Pas yetenekleri ve oyun görüşü sayesinde takımının hücumlarına yön verir. Ayrıca, kaleyi uzaktan denemeleriyle de etkili olabilen bir oyuncudur. Hücum hattına katkı sağlama konusunda yeteneklidir, ancak daha çok oyun kurma ve topu doğru şekilde dağıtma konusunda ön plandadır.</p>";

echo "<p><strong>İlk Dokunuş ve Baskı Altında Oyun:</strong> Fernández, top kontrolü ve ilk dokunuşu konusunda oldukça teknik bir oyuncudur. Baskı altındayken sakin kalabilir ve doğru kararlar vererek topu korur. Hızlı düşünme yeteneği sayesinde topu kolayca çıkarabilir ve hücuma hızlı geçişler yapabilir.</p>";

echo "<p><strong>Fiziksel Güç ve Çalışkanlık:</strong> Enzo Fernández, atletik yapısı ve yüksek çalışma hızı ile dikkat çeker. Hızlı ve çevik bir oyuncu olmasının yanı sıra, güçlü fiziğiyle rakiplerine karşı mücadele eder. Çalışkanlığı sayesinde oyun boyunca verimli bir şekilde enerjisini kullanır.</p>";

echo "<p><strong>Pozisyonlar:</strong> Enzo Fernández, orta sahanın merkezinde görev alarak oyun kurma görevini üstlenir. Genellikle ofansif orta saha veya derinlemesine oyun kurucu olarak görev yapabilir. Çok yönlü oyun tarzı, farklı orta saha dizilişlerinde görev yapabilmesini sağlar.</p>";

echo "<p><strong>Zayıf Yönler:</strong></p>";
echo "<ul>
    <li><strong>Fiziksel Dayanıklılık:</strong> Fiziksel olarak güçlü olsa da, bazen uzun süreli baskılara karşı dayanıklılığı azalabilir. Oyun sonunda yorgunluk yaşayabileceği anlar olabilir.</li>
    <li><strong>Hücumda Etkinlik:</strong> Hücumda daha fazla gol ve asist katkısı sağlaması gerekebilir. Bu alandaki katkısını geliştirmek, onun daha komple bir oyuncu olmasını sağlayacaktır.</li>
</ul>";

echo "<p><strong>Savunma Katkısı:</strong> Fernández, savunmada oyun okuma yeteneği ve alan daraltma konusunda güçlüdür. Zaman zaman top kapma ve pas arası yapma konusunda etkili olsa da, savunma sorumluluğunun daha fazla üzerine gitmesi gerekebilir. Ancak, takımına büyük oranda savunma güvenliği sağlar.</p>";

echo "<p><strong>Fiziksel ve Mental Özellikler:</strong></p>";
echo "<ul>
    <li><strong>Oyun Görüşü:</strong> Enzo Fernández, oyun görüşü açısından oldukça gelişmiş bir oyuncudur. Pas seçeneklerini hızlıca değerlendirip takım arkadaşlarına doğru zamanlamayla topu iletmekte ustadır.</li>
    <li><strong>Çalışkanlık:</strong> Sürekli olarak sahada her iki yönüyle de mücadele eder ve sahadaki temposunu hiç kaybetmez. Her zaman takımına katkı sağlamak için mücadele eder.</li>
    <li><strong>Liderlik:</strong> Genç yaşına rağmen liderlik özellikleri gösteren ve takımının oyununu yönlendiren bir oyuncudur. Sahada olgun kararlar verebilir.</li>
</ul>";

echo "<p><strong>Kariyer Gelişimi ve Potansiyeli:</strong> Enzo Fernández, genç yaşında Avrupa futbolunun en yetenekli orta saha oyuncularından biri olarak kabul edilmektedir. Teknik becerileri, oyun görüşü ve liderlik özellikleriyle, gelecekte dünyanın en elit orta saha oyuncularından biri olması beklenmektedir. Potansiyeli göz önüne alındığında, kariyerinde büyük başarılar elde edebilir.</p>";
...
$main_player_id = 127; // Örneğin, ana oyuncunun ID'si 1 olarak ayarlandı. Dinamik hale getirilebilir.
