...
$player_id = isset($_GET['player_id']) ? intval($_GET['player_id']) :45;
...
<body>
   ...
   echo "<p><strong>Pozisyonlar:</strong> Mustafa Hekimoğlu, sahada çok yönlü bir oyuncu olarak dikkat çeker. Genellikle hücum hattında yer alsa da, farklı pozisyonlarda da etkili performans sergileyebilir. En sık tercih edilen pozisyonu forvet olsa da, gerektiğinde kanatlarda da oynayabilir. Pozisyon esnekliği, farklı oyun dizilişlerine uyum sağlamasında önemli bir avantajdır.</p>";
   
   echo "<p><strong>Savunma Katkısı:</strong> Mustafa, hücumda olduğu kadar savunma yönünde de takımına katkı sağlar. Rakip savunma oyuncularına yaptığı pres ve hızlı geri dönüşleri, takım savunmasına destek olur. Pozisyon alma becerisi sayesinde savunmadan hücuma geçişlerde önemli bir rol oynar.</p>";
   
   echo "<p><strong>Fiziksel ve Mental Özellikler:</strong></p>";
   echo "<ul>
       <li><strong>Vizyon:</strong> Mustafa, oyunu okuma ve rakip savunmaların açıklarını fark etme konusunda oldukça yeteneklidir. Hücum organizasyonlarında takım arkadaşlarına fırsatlar yaratır.</li>
       <li><strong>Bitiricilik:</strong> Gol pozisyonlarını değerlendirme konusunda soğukkanlı ve etkili bir oyuncudur. Şut teknikleri ve doğru zamanda doğru yerde olma becerisiyle fark yaratır.</li>
       <li><strong>Çalışkanlık:</strong> Maç boyunca enerjisini yüksek tutar ve sürekli hareket halindedir. Hem hücum hem de savunmada takıma katkı sağlamak için çaba gösterir.</li>
   </ul>";
   
   echo "<p><strong>Kariyer Gelişimi ve Potansiyeli:</strong> Mustafa Hekimoğlu, genç yaşına rağmen büyük bir potansiyele sahiptir. Teknik becerileri, fiziksel özellikleri ve oyun zekası, onu gelecekte önemli bir hücum oyuncusu yapabilecek seviyededir. Çalışma disiplini ve gelişime açık yapısıyla kariyerinde hızlı bir yükseliş göstermesi beklenmektedir. Avrupa'nın üst düzey liglerinde kendine yer bulma potansiyeline sahiptir.</p>";
...
$main_player_id = 45; // Örneğin, ana oyuncunun ID'si 1 olarak ayarlandı. Dinamik hale getirilebilir.
