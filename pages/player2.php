...
$player_id = isset($_GET['player_id']) ? intval($_GET['player_id']) : 2;
                ...
                <div class="attributes-grid">
                    <div class="attribute-column">
                        ...
                        foreach ($technical as $attr) {
                            echo '<div class="attribute"><span>' . ucfirst(str_replace('_', ' ', $attr)) . ':</span><span>' . $player[$attr] . '</span></div>';
                        }
                        ?>
                    </div>
...
$main_player_id = 2; // Örneğin, ana oyuncunun ID'si 1 olarak ayarlandı. Dinamik hale getirilebilir.
