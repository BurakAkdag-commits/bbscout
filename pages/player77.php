...
$player_id = isset($_GET['player_id']) ? intval($_GET['player_id']) :77;
...
<body>
    <div class="container">
        ...
        <div class="player-report">
            ...
            <p>
            <?php
echo "<p><strong>Hücum Yeteneği:</strong> Alejandro Balde, Barcelona'nın sol kanadında harika bir hız ve dripling yeteneğiyle dikkat çekiyor. Geçtiğimiz sezon, 40 maçta 5 gol ve 8 asistle, hücumda önemli bir rol oynadı. Özellikle hızını ve çabukluğunu kullanarak rakip savunmaları geçme konusunda çok etkili.</p>";

echo "<p><strong>İlk Dokunuş ve Baskı Altında Oyun:</strong> Balde, dar alanlarda top kontrolünde güçlü ve pres altındayken de soğukkanlı kalabilen bir oyuncu. Hızlı kararlar alabilmesi, onu zor durumlarda bile faydalı kılıyor.</p>";

echo "<p><strong>Fiziksel Güç ve Çalışkanlık:</strong> Fiziksel olarak oldukça güçlü ve hızlı olan Balde, her iki yönlü oyun tarzıyla dikkat çekiyor. Savunmada ve hücumda hızlı bir geçiş yapabiliyor, bu da onun çok yönlü bir oyuncu olmasını sağlıyor. Hem hızlı hem de dayanıklı.</p>";

echo "<p><strong>Pozisyonlar:</strong> Balde, Barcelona'da genellikle sol bek olarak görev alıyor, ancak aynı zamanda sol kanat oyuncusu olarak da oynayabiliyor. Bu çok yönlülüğü, onu farklı oyun sistemlerine uyum sağlama konusunda değerli kılıyor.</p>";

echo "<p><strong>Zayıf Yönler:</strong></p>";
echo "<ul>
    <li><strong>Savunma Dikkati:</strong> Bazen savunmada pozisyon alırken dikkat dağınıklığı yaşanabiliyor. Bu, özellikle hızlı rakip hücumları karşısında dezavantaj yaratabiliyor.</li>
    <li><strong>Deneyim Eksikliği:</strong> Genç yaşına rağmen büyük bir potansiyele sahip olsa da, zaman zaman oyun temposuna alışma konusunda zorlanabiliyor.</li>
</ul>";

echo "<p><strong>Savunma Katkısı:</strong> Hızlı pres yapabilme ve rakip oyuncuları sıkıştırma konusunda yetenekli. Genç yaşına rağmen, pozisyon alma ve zamanlama becerileri ile savunmada sağlam bir duruş sergiliyor.</p>";

echo "<p><strong>Fiziksel ve Mental Özellikler:</strong></p>";
echo "<ul>
    <li><strong>Liderlik:</strong> Genç yaşına rağmen sahada liderlik özelliği gösteriyor ve takım arkadaşlarına örnek olacak şekilde motivasyon sağlıyor.</li>
    <li><strong>Çalışkanlık:</strong> Oyun boyunca sürekli hareket halinde olup, savunma ve hücumda etkili katkılar sağlıyor. Enerjisi bitmek bilmeyen bir oyuncu.</li>
</ul>";

echo "<p><strong>Kariyer Gelişimi ve Potansiyeli:</strong> Balde, Barcelona'da potansiyelini gösteren genç bir oyuncu olarak hızla yükseliyor. Hızlı ve teknik özellikleriyle modern futbolun ihtiyaç duyduğu sol bek profiline uygun. Gelecek yıllarda daha da gelişmesi ve uluslararası alanda büyük başarılar elde etmesi bekleniyor.</p>";
?>
<?php
// Veritabanı bağlantısı
...
$main_player_id = 77; // Örneğin, ana oyuncunun ID'si 1 olarak ayarlandı. Dinamik hale getirilebilir.
